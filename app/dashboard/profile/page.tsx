...
export default function ProfilePage() {
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="animate-pulse space-y-4">
          <div className="bg-gray-200 dark:bg-zinc-900 h-12 rounded" />
          <div className="bg-gray-200 dark:bg-zinc-900 h-48 rounded" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10 space-y-8">
      ...
      {/* Stats Card */}
      {profile && (
        <div className="bg-gray-50 dark:bg-zinc-950 rounded-xl p-6 flex flex-col md:flex-row gap-6 items-center">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <span className={`inline-block mt-2 px-3 py-1 rounded-full text-xs font-bold ${profile.role === 'ADMIN' ? 'bg-red-600 text-white' : 'bg-gray-200 dark:bg-zinc-800 text-gray-600 dark:text-gray-300'}`}>
              {profile.role}
            </span>
          </div>
          <div className="flex gap-6 text-center">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm">Watchlist</p>
            </div>
          </div>
        </div>
      )}
      ...
      {/* Update Name */}
      <div className="bg-gray-50 dark:bg-zinc-950 rounded-xl p-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-5">Update Profile</h2>
      ...
      {/* Change Password */}
      <div className="bg-gray-50 dark:bg-zinc-950 rounded-xl p-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-5">Change Password</h2>
