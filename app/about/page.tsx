...
export default function AboutPage() {
  return (
    <div className="bg-white dark:bg-black min-h-screen">
      {/* Hero */}
      <section className="relative py-20 px-4 bg-gradient-to-b from-red-950/30 to-white dark:to-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <MovingBorderCard key={stat.label} className="bg-gray-50 dark:bg-zinc-950 p-5 text-center" duration={3500}>
      ...
      {/* Features */}
      <section className="py-16 px-4 border-t border-gray-200 dark:border-zinc-900">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white text-center mb-10">What We Offer</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <MovingBorderCard key={f.title} className="bg-gray-50 dark:bg-zinc-950 p-6 text-center" duration={3000}>
      ...
      {/* CTA */}
      <section className="py-20 px-4 border-t border-gray-200 dark:border-zinc-900 bg-gradient-to-b from-white dark:from-black via-red-950/20 to-white dark:to-black">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-4">Join Our Community</h2>
          <p className="text-gray-500 dark:text-gray-400 mb-8">Create a free account and start discovering amazing movies today.</p>
